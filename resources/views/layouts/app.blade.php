...
<a href="{{ route('home') }}#event-list" class="hover:text-indigo-600 transition">
    Jelajahi
</a>

<a href="{{ route('home') }}#kategori" class="hover:text-indigo-600 transition">
    Kategori
</a>

<a href="{{ route('home') }}#tentang-kami" class="hover:text-indigo-600 transition">
    Tentang Kami
</a>
</div>
...
<ul class="space-y-4">
<li><a class="hover:text-white transition" href="{{ route('home') }}">Home</a></li>
<li><a class="hover:text-white transition" href="{{ route('home') }}">Semua Event</a></li>
<li><a class="hover:text-white transition" href="{{ route('home') }}">Cara Bayar</a></li>
</ul>
</div>
<div>
