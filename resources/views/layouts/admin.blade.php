...
<a class="flex items-center gap-3 px-4 py-3 bg-indigo-800 text-white rounded-xl font-bold transition" href="{{ route('admin.dashboard') }}">
...
<a class="flex items-center gap-3 px-4 py-3 hover:bg-indigo-800 rounded-xl font-bold transition" href="{{ route('admin.events.index') }}">
...
<a class="flex items-center gap-3 px-4 py-3 hover:bg-indigo-800 rounded-xl font-bold transition" href="{{ route('admin.transactions.index') }}">
...
<a class="flex items-center gap-3 px-4 py-3 text-indigo-300 hover:text-white transition font-medium" href="{{ route('home') }}">
