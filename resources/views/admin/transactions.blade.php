...
@section('title', 'Transaksi - AmikomEventHub')
...
<input class="flex-1 px-5 py-3 rounded-xl border-slate-200 border bg-white focus:ring-2 focus:ring-indigo-500 outline-none transition uppercase text-sm font-medium tracking-wide" placeholder="Cari Order ID, Nama, atau Email..." type="text"/>
</div>
