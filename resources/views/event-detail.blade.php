...
<img alt="Concert Poster" class="w-full rounded-[2.5rem] shadow-2xl border-8 border-white" src="{{ asset('assets/concert.png') }}"/>
...
<div class="space-y-4">
<span class="px-4 py-1.5 bg-indigo-100 text-indigo-700 rounded-full text-sm font-bold uppercase tracking-wider">Music
                    Festival</span>
...
<div>
<a class="inline-block px-10 py-5 bg-white text-indigo-600 rounded-2xl font-black text-xl hover:scale-105 transition-transform shadow-xl" href="{{ route('checkout') }}">
                            Pesan Sekarang
                        </a>
</div>
</div>
