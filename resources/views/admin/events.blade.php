...
@section('title', 'Kelola Event - AmikomEventHub')
...
<input class="flex-1 px-5 py-3 rounded-xl border-slate-200 border bg-white focus:ring-2 focus:ring-indigo-500 outline-none transition" placeholder="Cari nama event..." type="text"/>
...
<td class="px-8 py-6">
<img class="w-16 h-20 rounded-xl object-cover shadow-sm" src="{{ asset('assets/concert.png') }}"/>
</td>
<td class="px-8 py-6">
...
<path d="M11 5H6a2 2 0 00-2 2v11a2 2 0 00-2 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
</path>
</svg>
</button>
...
<td class="px-8 py-6">
<img class="w-16 h-20 rounded-xl object-cover shadow-sm" src="{{ asset('assets/workshop.png') }}"/>
</td>
<td class="px-8 py-6">
