...
@section('title', 'Dashboard Admin - AmikomEventHub')
...
<img class="rounded-xl" src="https://ui-avatars.com/api/?name=Admin+Super&amp;background=6366f1&amp;color=fff"/>
</div>
</div>
</header>
 Stats Grid 
...
<svg class="w-6 h-6" fill="none" stroke="currentColor" viewbox="0 0 24 24">
<path d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
</path>
</svg>
</div>
...
<a class="text-indigo-600 font-bold hover:underline" href="{{ route('admin.transactions.index') }}">Lihat Semua</a>
</div>
