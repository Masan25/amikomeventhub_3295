...
<div class="mb-12">
<a class="text-indigo-600 font-bold flex items-center gap-2 mb-6" href="{{ route('events.show', 1) }}">
...
<img alt="Event" class="w-24 h-24 rounded-2xl object-cover" src="{{ asset('assets/concert.png') }}"/>
<div>
...
<label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-wide">Nama
                            Lengkap</label>
<input class="w-full px-5 py-4 bg-white border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium" placeholder="Masukkan nama sesuai identitas" required="" type="text"/>
</div>
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
<div>
<label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-wide">Email
                                Aktif</label>
<input class="w-full px-5 py-4 bg-white border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium" placeholder="contoh@gmail.com" required="" type="email"/>
...
<label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-wide">No.
                                WhatsApp</label>
<input class="w-full px-5 py-4 bg-white border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 outline-none transition font-medium" placeholder="08xxxxxxx" required="" type="tel"/>
</div>
</div>
<button class="w-full py-5 bg-indigo-600 text-white rounded-2xl font-black text-xl shadow-xl shadow-indigo-200 hover:bg-indigo-700 active:scale-95 transition-all" onclick="showMidtrans()" type="button">
                        Bayar Sekarang
                    </button>
...
<div class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 hidden flex items-center justify-center p-6" id="midtrans-overlay">
...
<img alt="Midtrans Logo" class="h-6" src="https://midtrans.com/assets/img/logo-dark.png"/>
<button class="p-2 hover:bg-slate-200 rounded-full" onclick="hideMidtrans()">
...
<button class="w-full py-4 border-2 border-indigo-100 rounded-2xl flex justify-between items-center px-6 hover:border-indigo-600 transition group" onclick="window.location.href='ticket.html'">
<span class="font-bold group-hover:text-indigo-600">GoPay / QRIS</span>
<span class="text-indigo-400">→</span>
</button>
<button class="w-full py-4 border-2 border-indigo-100 rounded-2xl flex justify-between items-center px-6 hover:border-indigo-600 transition group opacity-50 cursor-not-allowed">
