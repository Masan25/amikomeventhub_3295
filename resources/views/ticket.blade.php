...
@section('content')
<section class="bg-indigo-600 text-white min-h-screen flex items-center justify-center p-6">
...
<div class="px-8 pb-8">
<button class="w-full py-4 bg-indigo-600 text-white rounded-2xl font-bold shadow-lg hover:bg-indigo-700 transition" onclick="window.print()">
                    Cetak / Simpan PDF
                </button>
<a class="block text-center mt-4 text-slate-500 font-bold hover:text-indigo-600" href="{{ route('home') }}">Kembali ke Beranda</a>
</div>
</div>
</div>
</section>
